...
class BaseDataset(Dataset):
    def __init__(self, cfg):
        ...
        # self.fx, self.fy = cfg['cam']['fx'], cfg['cam']['fy']
        # self.cx, self.cy = cfg['cam']['cx'], cfg['cam']['cy']
...
class ReplicaDataset(BaseDataset):
    def __init__(self, cfg, basedir, trainskip=1, 
        ...
        self.translation = translation
        self.sc_factor = sc_factor
        self.ds_start = cfg['data']['ds_start']
        self.ds_interval = cfg['data']['ds_interval']
        self.crop = crop
        ...
        self.img_files = self.img_files[self.ds_start: len(self.img_files): self.ds_interval]
        self.depth_paths = self.depth_paths[self.ds_start: len(self.depth_paths): self.ds_interval]
        self.poses = self.poses[self.ds_start: len(self.poses): self.ds_interval]
...
class TUMDataset(BaseDataset):
    def __init__(self, cfg, basedir, align=True, trainskip=1, 
        ...
        self.rays_d = None
        sx = float(self.crop_size[1] / self.W)
        sy = float(self.crop_size[0] / self.H)
        self.fx = sx*self.fx
        self.fy = sy*self.fy
        self.cx = sx*self.cx
        self.cy = sy*self.cy
        ...
        self.color_paths = self.color_paths[self.ds_start: len(self.color_paths): self.ds_interval]
        self.depth_paths = self.depth_paths[self.ds_start: len(self.depth_paths): self.ds_interval]
        self.poses = self.poses[self.ds_start: len(self.poses): self.ds_interval]
